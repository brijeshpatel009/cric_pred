...
//
//     final matchStatus = matchStatusFromJson(jsonString);

import 'dart:convert';

List<MatchStatus> matchStatusFromJson(String str) =>
    List<MatchStatus>.from(json.decode(str).map((x) => MatchStatus.fromJson(x)));
